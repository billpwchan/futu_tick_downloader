...
`/Users/billpwchan/Documents/futu_tick_downloader/scripts/run_snapshot_to_futu.command`

或命令列：

```bash
open /Users/billpwchan/Documents/futu_tick_downloader/scripts/run_snapshot_to_futu.command
```

可指定日期（例如 20260220）：

```bash
/Users/billpwchan/Documents/futu_tick_downloader/scripts/run_snapshot_to_futu.command 20260220
```
